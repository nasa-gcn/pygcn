...
context = {
    'DATATABLES_BASE': settings.DATATABLES_BASE,
    'JQUERY_BASE': settings.JQUERY_BASE
}


def index(request):
    return render_to_response('demo/index.html', context, context_instance = RequestContext(request))
...
def load_once_demo_view(request):
    ...
    return render_to_response('demo/load_once_demo.html', context, context_instance = RequestContext(request))
...
def server_side_demo_view(request):
   ...
   return render_to_response('demo/server_side_demo.html', context, context_instance = RequestContext(request))
